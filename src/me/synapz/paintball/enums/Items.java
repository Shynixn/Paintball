...
public enum Items {
    ...
    DUEL_WIELD("Duel Wield", Material.IRON_HOE, true, 1, "Lets you shoot from both hands", 0, 4, 120, "", "dueled", Sounds.ARROW_HIT.bukkitSound(), 1),
    RAPID_FIRE("Rapid Fire", Material.DIAMOND_HOE, true, 1, "Allows you to left or right click\nto shoot", 0, 4, 0, "pieced", "", Sounds.ARROW_HIT.bukkitSound(), 1),
    AK_47("AK-47", Material.GOLD_BARDING, true, 1, "Shoot with 100% accuracy\nout of an AK-47", 0, 5, 120, "", "mowed down",  Utils.DEFAULT_SOUND, 1),
